        ...
        <div id="wrapper" className="md:flex md:justify-center md:items-center min-h-screen bg-[#8C7456]">
            <form action=""
                ...
                <div id="remember-forgot"
                     className="md:flex justify-between text-[15px] mt-[15px] mb-[15px] mr-0 ml-0 ">
                    <label className="accent-[#EEEEEE]">
                        <input type="checkbox" className="mr-[3px] ml-[1px]"></input>
                        Запомнить пароль
                    </label>
                ...
                <div id="Register_link" className="text-[15px] text-center mt-[15px]">
                    <p><Link search={{}} to="/register" className="font-semibold hover:underline">Создать аккаунт</Link></p>
                </div>
            </form>
        </div>
    )
